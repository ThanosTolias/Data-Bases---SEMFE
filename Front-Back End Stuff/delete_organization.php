        ...
        <div class="col-md-12">
            <form class="form-horizontal" name="project_form" method="POST">
                ...
                <?php
                        ...
                        $id = $_GET['id'];
                        $query1 = "SELECT organization_id, name_org FROM organization WHERE organization_id = '$id'";
                        $res1 = mysqli_query($conn, $query1);
                        $row1 = mysqli_fetch_row($res1);

                        echo '<div class="form-group col-sm-3 mb-3">';
                        echo '<label class = "form-label" style="width: 300px;">Are you sure you want to DELETE organization: <br><b>' . $row1[0] . '  ' . $row1[1] . '?</b></label>';
                        echo '</div>';
                        ...
                        if(isset($_POST['submit_del'])){
                            ...
                            if (mysqli_query($conn, $query)) {
                                header("Location: ./show_all_organizations.php");             
                                exit();
                            }
                            else{
