...
for _ in range(DUMMY_DATA_NUMBER_2):
    ...
    if(organisationtype == "Company"):
        fundscompany = random.randint(0,10000000)
    elif(organisationtype == "University"): 
        budgetuniministry = random.randint(0,10000000)
    else:
        budgetRC1 = random.randint(0,10000000)
...
for i in range(DUMMY_DATA_NUMBER_3):
    ...
    day1 = random.randint(1,28)
    month1 = random.randint(1,12)
    year1 = random.randint(year+1,2030)
    enddate = str(year1) + "-" + str(month1) + "-" + str(day1)
    day2 = random.randint(1,28)
    month2 = month 
    year2 = year
    dateEval = str(year2) + "-" + str(month2) + "-" + str(day2)
...
for _ in range(DUMMY_DATA_NUMBER_8):
    ...
    abstract = fake.paragraph(nb_sentences=2)
    day4 = random.randint(1,28)
    month4 = random.randint(1,12)
    year4 = random.randint(2020, 2025)
